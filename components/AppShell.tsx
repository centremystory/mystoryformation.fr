...
const NAV: Entree[] = [
  ...
  { type: "link", href: "/reglages", label: "Réglages", icon: Settings, membres: ["/centres", "/catalogue"] },
  {
    type: "menu", label: "Formation", icon: GraduationCap, items: [
      ...
      { href: "/inscriptions/nouvelle", label: "Inscrire un stagiaire", icon: Plus, membres: ["/positionnements"] },
      { href: "/dossiers", label: "Dossiers", icon: FolderOpen, membres: ["/dossiers/conformite", "/dossiers/edof", "/edof", "/identites"] },
      { href: "/emargement", label: "Suivi & présences", icon: ClipboardCheck, membres: ["/suivi-eleves", "/calendrier", "/planning"] },
      { href: "/contenu-pedagogique", label: "Pédagogie", icon: BookOpen, membres: ["/programmes"] },
      { href: "/tests/tous", label: "Tests", icon: ClipboardList, membres: ["/tests/a-noter", "/tests/banque", "/tests/relances"] },
  ...
  },
  {
    type: "menu", label: "Examen", icon: ClipboardList, items: [
      ...
      { href: "/examens/vente-groupe", label: "Inscrire un candidat", icon: Plus, membres: ["/examens/preinscriptions"] },
      { href: "/examens/candidats", label: "Candidats", icon: Users, membres: ["/examens/croise"] },
      { href: "/examens/sessions", label: "Sessions & jour", icon: CalendarDays, membres: ["/examens/jour", "/examens/liste-attente"] },
      { href: "/examens/corrections", label: "Résultats", icon: FileCheck, membres: ["/examens/taux"] },
  ...
  {
    type: "menu", label: "Communication", icon: MessageSquare, items: [
      { href: "/equipe-messages", label: "Messagerie", icon: Megaphone, membres: ["/messages", "/interne"] },
      { href: "/faq", label: "Guides", icon: HelpCircle, membres: ["/techniques-vente", "/guide-formatrices"] },
...
const ALIAS_EXAMEN: Record<string, string> = {
  ...
  "/examens/jour": "/examens/sessions",
  "/examens/liste-attente": "/examens/sessions",
