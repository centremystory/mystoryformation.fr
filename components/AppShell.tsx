...
const NAV: Entree[] = [
  ...
  { type: "link", href: "/reglages", label: "Réglages", icon: Settings, membres: ["/centres"] },
  {
    type: "menu", label: "Formation", icon: GraduationCap, items: [
      ...
      { href: "/taches", label: "Tâches", icon: CheckCircle2 },
      { href: "/ventes-formation", label: "Ventes formation", icon: TrendingUp },
      { href: "/cockpit-commercial", label: "Cockpit commercial", icon: BarChart3 },
      ...
      { href: "/guide-formatrices", label: "Guide formatrices", icon: BookOpen },
      ...
      { href: "/edof", label: "EDOF", icon: FileSpreadsheet },
      { href: "/identites", label: "Identités", icon: ShieldCheck },
    ],
  },
  {
    type: "menu", label: "Examen", icon: ClipboardList, items: [
      ...
      { href: "/examens/jour", label: "Examens du jour", icon: CalendarDays },
  ...
  },
  {
    type: "menu", label: "Relation", icon: MessageSquare, items: [
      { href: "/reclamations", label: "Réclamations", icon: MessageCircle },
      { href: "/equipe-messages", label: "Fil d'équipe", icon: Megaphone },
