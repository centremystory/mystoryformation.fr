...
export default function GuideFormatricesPage() {
  ...
  async function sauverEdit(id: string) {
    ...
    try {
      await apiFetch("/api/guide-formatrices", { method: "PATCH", body: JSON.stringify({ id, ...e }) });
  ...
  async function archiver(id: string) {
    ...
    try {
      await apiFetch("/api/guide-formatrices", { method: "PATCH", body: JSON.stringify({ id, action: "archiver" }) });
  ...
  async function ajouter() {
    ...
    try {
      await apiFetch("/api/guide-formatrices", { method: "POST", body: JSON.stringify(nouv) });
