...
export async function GET(_req: NextRequest) {
  const { data, error } = await supabaseAdmin
    ...
    .select(
      "id, source, nom, prenom, civilite, email, telephone, type_brut, type_norm, sous_type, date_examen, horaire, agence, statut_paiement, numero_attestation, numero_facture, vendu_par, montant, a_confirmer, date_inscription"
    )
